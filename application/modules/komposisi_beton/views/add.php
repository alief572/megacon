                    ...
                    <tbody class="list_detail_material">
                        ...
                        if (!empty($detail)) {
                            foreach ($detail as $item) {
                                ...
                                echo '<select name="detail_material[' . $no . '][id_material]" class="form-control form-control-sm chosen_select id_material" data-no="' . $no . '">';
...
<script>
    ...
    $(document).on('click', '.add_material', function() {
        ...
        hasil += '<select name="detail_material[' + no_detail_material + '][id_material]" class="form-control form-control-sm chosen_select id_material" data-no="' + no_detail_material + '">';
    ...
    $(document).on('change', '.id_material', function() {
        ...
        $.ajax({
            type: 'post',
            url: siteurl + active_controller + '/get_material_name',
            data: {
