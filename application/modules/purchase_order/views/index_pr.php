				...
				?>
									...
									<tr>
										...
										<td class="text-center"><?php if ($ENABLE_MANAGE) : ?>
												<input <?php //echo $disabled
														?> type="checkbox" class="set_choose_do" name="set_choose_do" id="set_choose_do<?php echo $numb ?>" value="<?php echo $record->so_number ?>" onclick="cekcus('<?php echo $record->nama_user ?>','<?php echo $numb ?>','<?php echo $vso->ppn ?>','<?php echo $vso->nm_customer ?>','<?php echo 'set_choose_do' . $numb ?>')" data-tipe_pr="<?= $record->tipe_pr ?>" <?= $checked ?>>
											<?php endif; ?>
										</td>
							...
							if ($no_materil > $no_materil_po) {
								...
								<tr>
									...
									<td class="text-center"><?= $status ?></td>
									<td class="text-center"><?php if ($ENABLE_MANAGE) : ?>
											<input type="checkbox" class="set_choose_do" name="set_choose_do" id="set_choose_do<?php echo $numb ?>" value="<?php echo $record->so_number ?>" onclick="cekcus('<?php echo $record->nama_user ?>','<?php echo $numb ?>','<?php echo $vso->ppn ?>','<?php echo $vso->nm_customer ?>','<?php echo 'set_choose_do' . $numb ?>')" data-tipe_pr="<?= $record->tipe_pr ?>" <?= $checked ?>>
										<?php endif; ?>
									</td>
