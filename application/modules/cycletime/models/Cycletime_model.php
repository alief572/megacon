...
class Cycletime_model extends BF_Model
{
  ...
  public function __construct()
  {
    ...
    $this->ENABLE_ADD     = has_permission('Cycletime.Add');
    $this->ENABLE_MANAGE  = has_permission('Cycletime.Manage');
    $this->ENABLE_VIEW    = has_permission('Cycletime.View');
    $this->ENABLE_DELETE  = has_permission('Cycletime.Delete');
  }
