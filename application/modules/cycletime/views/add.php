	...
	<div class="box-body"><br>
		<form id="data-form" method="post">
			<div class="form-group row">
				...
				<div class="col-md-10">
					<select id="produk" name="produk" class="form-control form-control-sm" required>
					...
					<table class='table table-striped table-bordered table-hover table-condensed' width='100%'>
						<thead>
							<tr class='bg-blue'>
								...
								<th class='text-center' style='width: 40%;'>Area</th>
		...
		$(document).on('change', '#produk', function() {
			...
			$.ajax({
				...
				success: function(data) {
					...
					let no_bom_list = $('#no_bom');
					no_bom_list.empty();
					
					no_bom_list.append(data.option);
					no_bom_list.trigger('chosen:updated');
				}
			});
		});
		//add part
