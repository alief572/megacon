...
class Cycletime extends Admin_Controller
{
  ...
  public function edit()
  {
    ...
    $machine  = $this->db->query("SELECT a.* FROM asset a JOIN rate_machine b ON b.kd_mesin = a.kd_asset WHERE a.category='2' AND a.deleted_date IS NULL AND b.deleted_by IS NULL GROUP BY a.kd_asset ORDER BY a.nm_asset ASC ")->result_array();
    $mould  = $this->db->query("SELECT a.* FROM asset a JOIN rate_mold b ON b.kd_mesin = a.kd_asset WHERE a.category='1' AND a.deleted_date IS NULL AND b.deleted_by IS NULL GROUP BY a.kd_asset ORDER BY a.nm_asset ASC ")->result_array();
  ...
  public function get_add()
  {
    ...
    $d_Header .= "<td align='center'></td>";
    $d_Header .= "<td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' class='btn btn-sm btn-warning addPart' title='Add Area'><i class='fa fa-plus'></i>&nbsp;&nbsp;Add Area</button></td>";
    $d_Header .= "<td align='center'></td>";
    $d_Header .= "<td align='center'></td>";
    $d_Header .= "<td align='center'></td>";
    $d_Header .= "<td align='center'></td>";
