<?php
$ENABLE_ADD     = has_permission('BOM_HI-Grid_Custom.Add');
$ENABLE_MANAGE  = has_permission('BOM_HI-Grid_Custom.Manage');
$ENABLE_VIEW    = has_permission('BOM_HI-Grid_Custom.View');
$ENABLE_DELETE  = has_permission('BOM_HI-Grid_Custom.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
