                            ...
                            <div class="col-lg-5">
                                <div class="form-group " style="padding-top:15px;">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" name="total_price_before_discount_new" class="form-control input-sm text-right" id="total_price_before_discount_new" value="<?= $total_price_before_discount ?>" readonly>
                                    </div>
                                </div>
                            </div>
...
//END GET DATA INVENTORY
                    ...
                    <div class="col-lg-4">
                        <div class="form-group " style="padding-top:15px;">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="jarak_pengiriman_truck_dc" class="form-control text-right" id="jarak_pengiriman_truck_dc" onkeyup="formatNumber(this)">
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-lg-8">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group " style="padding-top:15px;">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="estimasi_tol_bt" class="form-control text-right" id="estimasi_tol_bt" onkeyup="formatNumber(this)">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12"></div>
...
$(document).on('change', '.get_data_truck', function() {//test
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            var biayaDelivery = total_biaya_delivery ?? 0; // jika null atau undefined, jadi 0
            if(total_biaya_delivery == 0 || total_biaya_delivery == ''){
                var grand_total_delivery = result.grand_total + biayaDelivery;
            }else{
