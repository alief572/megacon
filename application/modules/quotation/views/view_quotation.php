...
?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group " style="padding-top:15px;">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="jarak_pengiriman_truck_dc" class="form-control text-right" id="jarak_pengiriman_truck_dc" value="<?= number_format(@$results['get_delivery_cost_header']->jarak_pengiriman) ?>">
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-lg-8">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group " style="padding-top:15px;">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="estimasi_tol_bt" class="form-control text-right" id="estimasi_tol_bt" value="<?= number_format(@$results['get_delivery_cost_header']->estimasi_tol) ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12"></div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group " style="padding-top:15px;">
                            ...
                            (@$results['get_delivery_cost_header']->total_charger_biaya_lain_lain) ?>">
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-lg-12"></div>
