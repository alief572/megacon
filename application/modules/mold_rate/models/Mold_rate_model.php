...
class Mold_rate_model extends CI_Model
{
    public function __construct()
    {
        parent::__construct();
        $this->table_name = 'rate_mold';
        $this->key        = 'id';

        $this->viewPermission   = 'Mold_Rate.View';
        $this->addPermission    = 'Mold_Rate.Add';
        $this->managePermission = 'Mold_Rate.Manage';
        $this->deletePermission = 'Mold_Rate.Delete';
    }
