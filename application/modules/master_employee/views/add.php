            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class='form-group row'>
                        ...
                        <div class='col-sm-4'>
                            <?php
                            echo form_input(array('id' => 'tgl_lahir', 'name' => 'tgl_lahir', 'class' => 'form-control input-md', 'type' => 'date', 'placeholder' => 'Date of birth'), $tgl_lahir);
                            ?>
                        </div>
                    </div>
                    <div class='form-group row'>
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-4'>
                                <?php
                                echo form_input(array('id' => 'tgl_join', 'name' => 'tgl_join', 'class' => 'form-control input-md', 'type' => 'date', 'placeholder' => 'Join Date'), $tgl_join);
                                ?>
                            </div>
                            <label class='label-control col-sm-2'><b>End Date</b></label>
                            <div class='col-sm-4'>
                                <?php
                                echo form_input(array('id' => 'tgl_end', 'name' => 'tgl_end', 'class' => 'form-control input-md', 'type' => 'date', 'placeholder' => 'End Date'), $tgl_end);
                                ?>
                            </div>
                        </div>
                        <div class='form-group row'>
