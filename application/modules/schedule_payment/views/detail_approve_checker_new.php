...
<div class="box">
	<div class="box-body">
		...
		<div class="row">
			<input type="hidden" name="id" value="<?= $dataPO->no_surat; ?>">
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-6" style="margin-bottom: 1rem;">
						<input type="text" name="no_doc" class="form-control" readonly value="<?= $dataPO->no_surat; ?>">
					</div>
...
<script type="text/javascript">
	// var url_save = siteurl + 'request_payment/save_approval_checker';//version old 
	var url_save = siteurl + 'schedule_payment/save_approval_checker_new';//version new
