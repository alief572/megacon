                    ...
                    <tbody>
                        ...
                        foreach ($data as $item_kasbon) :
                            if ($item_kasbon->tipe == 'kasbon') {
                                ...
                                echo '<td>';
                                if ($ENABLE_MANAGE && $get_sts_payment['status'] < 1) : ?>
                                    <div class="text-center"><a href="<?= base_url($this->uri->segment(1) . '/approval_payment_checker/?type=' . $item_kasbon->tipe . '&id=' . $item_kasbon->id . '&nilai=' . $item_kasbon->jumlah); ?>" name="save" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o">&nbsp;</i>Approve</a></div>
                        ...
                        $angka = 0;
                            foreach ($dataNew as $item_expense_new) :
                                ...
                                echo '</td>';
                                    ...
                                    <a href="<?= base_url($this->uri->segment(1) . '/approval_payment_checker_new/?no_po=' . $NO_PO); ?>" name="save" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o"></i></a>
