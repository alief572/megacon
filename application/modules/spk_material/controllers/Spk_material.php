...
class Spk_material extends Admin_Controller
{
  ...
  public function get_add_plan()
  {
    ...
    $d_Header .= "</td>";
    $d_Header .= "<td align='left'>";
    $d_Header .= "<select name='Detail[" . $id . "][m3]' class='chosen-select form-control input-sm inline-blockd product'>";
    ...
    $d_Header .= "</td>";
    $d_Header .= "<td align='left'>";
    $d_Header .= "<input type='text' name='Detail[" . $id . "][propose]' class='form-control input-md text-center' placeholder='Propose'>";
    $d_Header .= "</td>";
    $d_Header .= "<td align='left'>";
    $d_Header .= "<input type='text' name='Detail[" . $id . "][m3]' class='form-control input-md text-center' placeholder='m3/pcs'>";
    $d_Header .= "</td>";
    $d_Header .= "</td>";
    $d_Header .= "<td align='left'>";
    $d_Header .= "<input type='text' name='Detail[" . $id . "][shift1]' class='form-control input-md text-center' placeholder='Shift 1'>";
    $d_Header .= "</td>";
    $d_Header .= "</td>";
    $d_Header .= "<td align='left'>";
    $d_Header .= "<input type='text' name='Detail[" . $id . "][shift2]' class='form-control input-md text-center' placeholder='shift2'>";
    $d_Header .= "</td>";
    $d_Header .= "<td align='left'>";
    $d_Header .= "<input type='text' name='Detail[" . $id . "][total_kubikasi]' class='form-control input-md text-center' placeholder='Total Kubikasi'>";
    $d_Header .= "</td>";
    $d_Header .= "<td align='center'>";
    ...
    // $d_Header .= "<td align='center'></td>";
    $d_Header .= "<td align='center'>8888</td>";
    $d_Header .= "</tr>";
