<div class="box box-primary">
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<div class='col-sm-3'>
				<?php
				$empid = (!empty($data->employee_id)) ? $data->employee_id : 0;
				$employeex[0] = 'Select An Employee';
				foreach ($employee as $key => $value) {
					$employeex[$value['id']] = strtoupper($value['nm_karyawan']);
				}
				echo form_dropdown('employee_id', $employeex, $empid, array('id' => 'employee_id', 'class' => 'form-control input-md', 'required' => 'required'));
				?>
			</div>
		</div>
		<div class="form-group">
