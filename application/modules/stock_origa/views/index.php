		...
		<table id="example1" class="table table-bordered table-striped" width='100%'>
			<thead>
				<tr>
					...
					<th>Type BOM</th>
					<th>Product Name</th>
					<th class='text-center no-sort'>Actual Stock<br>Belum Matang</th>
					<th class='text-center no-sort'>Actual Stock<br>Matang</th>
					<!-- <th class='text-center no-sort'>Booking<br>Stock</th> -->
	...
	<script type="text/javascript">
		...
		function DataTables(costcenter = null, product = null) {
			var dataTable = $('#example1').DataTable({
				...
				"ajax": {
					url: siteurl + active_controller + 'data_side_stock_milik_origa',
					type: "post",
					data: function(d) {
