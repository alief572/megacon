...
<div class="box box-primary">
	<div class="box-body">
		<form id="data_form" autocomplete="off">
			...
			<div class="form-group row">
				<div class="col-md-3">
				<label for="">Type Code <span class='text-danger'>*</span></label>
				</div>
				<div class="col-md-9">
				<input type="text" class="form-control" id="code_manual" required name="code_manual" placeholder="Type Code" value='<?=$code_manual;?>'>
				</div>
			</div>
			<?php if(!empty($id)){ ?>
			<div class="form-group row">
