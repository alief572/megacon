...
<form id="form-header-mutasi" method="post">
    <div class="nav-tabs-salesorder">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control no_surat" id="" name="no_surat" readonly placeholder="Quotation No" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->no_penawaran : null ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="date" class="form-control" id="tanggal" onkeyup required name="tanggal" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->tgl_penawaran : null ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class='col-sm-6'>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea name="notes" id="" cols="30" rows="5" class="form-control" readonly><?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->notes : null ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-sm-6'>
		...
		*/
            ...
            $(document).on('click', '.pilih_action', function() {
                var pilih_action = $(this).val();
                if (pilih_action == '0') {
                    $('.keterangan_approve').show();
                } else {
                    $('.keterangan_approve').hide();
                }
            });
