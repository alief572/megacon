<?php
$ENABLE_ADD     = has_permission('PR_Material.Add');
$ENABLE_MANAGE  = has_permission('PR_Material.Manage');
$ENABLE_VIEW    = has_permission('PR_Material.View');
$ENABLE_DELETE  = has_permission('PR_Material.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
...
<div class="box">
	<div class="box-header">
		<?php if ($ENABLE_ADD) : ?>
			...
			<a class="btn btn-success btn-md" style='float:right;' href="<?= base_url('request_pr_material/add') ?>" title="Add">Add</a>
		<?php endif; ?>
		<br>
