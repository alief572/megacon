<?php
$ENABLE_ADD     = has_permission('Material_Planning_Base_On_Produksi.Add');
$ENABLE_MANAGE  = has_permission('Material_Planning_Base_On_Produksi.Manage');
$ENABLE_VIEW    = has_permission('Material_Planning_Base_On_Produksi.View');
$ENABLE_DELETE  = has_permission('Material_Planning_Base_On_Produksi.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
		...
		<table id="example1" class="table table-bordered table-striped" width='100%'>
			<thead>
				<tr>
					...
					<th>Customer</th>
					<th>Project</th>
					<th>Qty Order SO (Kg)</th>
					<th>Use Stock (Kg)</th>
					<th>Propose Purchase (Kg)</th>
	...
	<script type="text/javascript">
		...
		function DataTables(costcenter = null, product = null) {
			var dataTable = $('#example1').DataTable({
				...
				"ajax": {
					url: siteurl + active_controller + 'data_side_material_planning',
					type: "post",
					data: function(d) {
